  ...
  module MediaServices
    module Mgmt
      ...
      class MediaServicesManagementClass
        attr_reader :mediaservices, :assets, :content_key_policies, :transforms, :jobs, :streaming_policies, :streaming_locators, :live_events, :live_outputs, :operations, :streaming_endpoints, :locations, :configurable, :base_url, :options, :model_classes
