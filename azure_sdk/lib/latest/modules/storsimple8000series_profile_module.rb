  ...
  module StorSimple8000Series
    module Mgmt
      ...
      class StorSimple8000SeriesManagementClass
        attr_reader :alerts, :bandwidth_settings, :cloud_appliances, :devices, :device_settings, :backup_schedules, :hardware_component_groups, :volume_containers, :volumes, :storage_account_credentials, :jobs, :backup_policies, :operations, :backups, :managers, :access_control_records, :configurable, :base_url, :options, :model_classes
