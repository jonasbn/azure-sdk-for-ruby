  ...
  module ServiceBus
    module Mgmt
      ...
      class ServiceBusManagementClass
        attr_reader :topics, :namespaces, :regions, :operations, :disaster_recovery_configs, :migration_configs, :queues, :premium_messaging_regions_operations, :event_hubs, :rules, :subscriptions, :configurable, :base_url, :options, :model_classes
