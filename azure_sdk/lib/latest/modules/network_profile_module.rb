  ...
  module Network
    module Mgmt
      ...
      class NetworkManagementClass
        attr_reader :operations, :azure_firewalls, :express_route_circuit_authorizations, :application_security_groups, :available_endpoint_services, :express_route_circuit_connections, :ddos_protection_plans, :application_gateways, :express_route_service_providers, :express_route_circuit_peerings, :express_route_circuits, :load_balancer_backend_address_pools, :express_route_cross_connections, :express_route_cross_connection_peerings, :load_balancer_load_balancing_rules, :load_balancer_frontend_ipconfigurations, :load_balancers, :network_interfaces, :load_balancer_network_interfaces, :load_balancer_probes, :inbound_nat_rules, :network_interface_load_balancers, :default_security_rules, :network_security_groups, :network_interface_ipconfigurations, :connection_monitors, :route_filters, :network_watchers, :packet_captures, :virtual_networks, :security_rules, :public_ipaddresses, :route_tables, :routes, :usages, :vpn_sites, :route_filter_rules, :bgp_service_communities, :virtual_network_peerings, :local_network_gateways, :vpn_connections, :vpn_sites_configuration, :virtual_hubs, :subnets, :virtual_network_gateways, :virtual_network_gateway_connections, :hub_virtual_network_connections, :vpn_gateways, :virtual_wans, :configurable, :base_url, :options, :model_classes
