  ...
  module RecoveryServicesSiteRecovery
    module Mgmt
      ...
      class RecoveryServicesSiteRecoveryManagementClass
        attr_reader :replication_alert_settings, :replication_events, :replication_fabrics, :replication_logical_networks, :replication_networks, :replication_network_mappings, :replication_protection_containers, :replication_protectable_items, :replication_protected_items, :target_compute_sizes, :replication_protection_container_mappings, :recovery_points, :replication_recovery_services_providers, :replication_storage_classification_mappings, :replicationv_centers, :replication_storage_classifications, :replication_jobs, :replication_recovery_plans, :replication_vault_health, :replication_policies, :operations, :configurable, :base_url, :options, :model_classes
