...
module Azure::Profiles::Latest
  module GraphRbac
    ...
    class GraphRbacDataClass
      attr_reader :applications, :deleted_applications, :groups, :service_principals, :objects, :domains, :users, :oauth2, :signed_in_user, :configurable, :base_url, :options, :model_classes
